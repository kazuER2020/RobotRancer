...
#define SERVO_CENTER   78 // サーボの中心位置(各機体に合わせて調整が必要) //hs-311: 78
#define RIGHT_HEIKOU   90 // 槍を右に振る時の角度(平行標的)
#define RIGHT_SUICHOKU_A 48 // (※A標的)槍を右に振る時の角度(垂直標的)
#define LEFT_SUICHOKU_B -40 // 槍を左に振る時の角度(垂直標的)
#define RIGHT_SUICHOKU_C 35 // (※C標的)槍を右に振る時の角度(垂直標的)
#define LEFT_SUICHOKU_D -34 // 槍を左に振る時の角度(垂直標的)
